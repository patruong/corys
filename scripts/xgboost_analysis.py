...
def scatter_actual_vs_prediction(X, y, n_estimators, title ='XGBoost Regression - Actual vs. Predicted log2 signal enhancement',
                                 save_path = "XGBoost_regression.png"):
...
def plot_feature_importance_bar_plot(df, X,y,n_estimators, title = 'XGBoost Regression - Preceding feature importance',
...
def generate_xgboost_plots(df,
                           scatter_title = 'XGBoost Regression - Actual vs. Predicted log2 signal enhancement',
                           bar_title = 'XGBoost Regression - Preceding feature importance',
                           scatter_save_path = "XGBoost_regression.png",
                           bar_save_path = "XGBoost_feature_importance.png"):
    ...
    scatter_actual_vs_prediction(X,y,n_estimators=best_n_estimator,title = scatter_title,
...
if __name__ == "__main__":
    ...
    generate_xgboost_plots(df = preceding_df,
                           scatter_title = 'XGBoost Regression - Preceding signal enhancement',
                           bar_title = 'XGBoost Regression - Preceding feature importance',
                           scatter_save_path = "xgboost/XGBoost_regression_preceding.png",
                           bar_save_path = "xgboost/XGBoost_feature_importance_preceding.png")
    
    generate_xgboost_plots(df = preceding_df_no_deriv,
                           scatter_title = 'XGBoost Regression - Preceding signal enhancement (no deriv)',
                           bar_title = 'XGBoost Regression - Preceding feature importance (no deriv)',
                           scatter_save_path = "xgboost/XGBoost_regression_preceding(no deriv).png",
                           bar_save_path = "xgboost/XGBoost_feature_importance_preceding(no deriv).png")
    
    # generate plots from succeeding ratios
    generate_xgboost_plots(df = succeeding_df,
                           scatter_title = 'XGBoost Regression - Succeeding signal enhancement',
                           bar_title = 'XGBoost Regression - Succeeding feature importance',
                           scatter_save_path = "xgboost/XGBoost_regression_succeeding.png",
                           bar_save_path = "xgboost/XGBoost_feature_importance_succeeding.png")
    
    generate_xgboost_plots(df = succeeding_df_no_deriv,
                           scatter_title = 'XGBoost Regression - Succeeding signal enhancement (no deriv)',
                           bar_title = 'XGBoost Regression - Succeeding feature importance (no deriv)',
                           scatter_save_path = "xgboost/XGBoost_regression_succeeding(no deriv).png",
                           bar_save_path = "xgboost/XGBoost_feature_importance_succeeding(no deriv).png")
