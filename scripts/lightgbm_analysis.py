...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 19:52:28 2023
...
def compute_eval_metrics(X, y, n_estimators=50):
    ...
    # CV model
    model = lgb.LGBMRegressor()  # Change here: Use LGBMRegressor instead of XGBRegressor
...
def grid_search_CV(X, y, n_estimators = [100, 150, 200, 250, 300]):
    ...
    model = lgb.LGBMRegressor(n_estimators=best_n_estimators) 
    model.fit(X_train, y_train)
...
def scatter_actual_vs_prediction(X, y, n_estimators, title ='LightGBM Regression - Actual vs. Predicted log2 signal enhancement',
                                 save_path = "LightGBM_regression.png"):
...
def plot_feature_importance_bar_plot(df, X, y, n_estimators, title='LightGBM Regression - Preceding feature importance',
...
def generate_lightgbm_plots(df,
                            scatter_title='LightGBM Regression - Actual vs. Predicted log2 signal enhancement',
                            bar_title='LightGBM Regression - Preceding feature importance',
                            scatter_save_path="lightgbm/LightGBM_regression_preceding.png",
                            bar_save_path="lightgbm/LightGBM_feature_importance_preceding.png"):
...
if __name__ == "__main__":
    ...
    generate_lightgbm_plots(df=preceding_df,
                                scatter_title='LightGBM Regression - Preceding signal enhancement',
                                bar_title='LightGBM Regression - Preceding feature importance',
                                scatter_save_path="lightgbm/RandomForest_regression_preceding.png",
                                bar_save_path="lightgbm/RandomForest_feature_importance_preceding.png")
    
    generate_lightgbm_plots(df=preceding_df_no_deriv,
                                scatter_title='LightGBM Regression - Preceding signal enhancement (no deriv)',
                                bar_title='LightGBM Regression - Preceding feature importance (no deriv)',
                                scatter_save_path="lightgbm/RandomForest_regression_preceding(no_deriv).png",
                                bar_save_path="lightgbm/RandomForest_feature_importance_preceding(no_deriv).png")
    
    # generate plots from succeeding ratios
    generate_lightgbm_plots(df=succeeding_df,
                                scatter_title='LightGBM Regression - Succeeding signal enhancement',
                                bar_title='LightGBM Regression - Succeeding feature importance',
                                scatter_save_path="lightgbm/RandomForest_regression_succeeding.png",
                                bar_save_path="lightgbm/RandomForest_feature_importance_succeeding.png")
    
    generate_lightgbm_plots(df=succeeding_df_no_deriv,
                                scatter_title='LightGBM Regression - Succeeding signal enhancement (no deriv)',
                                bar_title='LightGBM Regression - Succeeding feature importance (no deriv)',
                                scatter_save_path="lightgbm/RandomForest_regression_succeeding(no_deriv).png",
                                bar_save_path="lightgbm/RandomForest_feature_importance_succeeding(no_deriv).png")
